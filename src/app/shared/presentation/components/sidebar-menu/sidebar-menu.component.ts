...
export class SidebarMenuComponent {
  ...
  readonly restaurantMenuItems: MenuItem[] = [
    ...
    { id: 'inventory', path: '/restaurant/inventory', i18nKey: 'shared.sidebar.inventory', iconOff: '/assets/images/icons/inventory-icon.svg', iconOn: '/assets/images/icons/inventory-on-icon.svg' },
    { id: 'orders', path: '/restaurant/orders', i18nKey: 'shared.sidebar.orders', iconOff: '/assets/images/icons/orders-icon.svg', iconOn: '/assets/images/icons/orders-on-icon.svg' },
    { id: 'kitchen-tickets', path: '/restaurant/kitchen', i18nKey: 'shared.sidebar.kitchen-tickets', iconOff: '/assets/images/icons/kitchen-ticket-icon.svg', iconOn: '/assets/images/icons/kitchen-tickets-on-icon.svg', exact: true },
